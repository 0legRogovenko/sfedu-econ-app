    ...
    try:
        ...
        lessons = [
            Lesson(
                ...
                weekday=0,
                pair_number=1,
                starts_at=PAIR_TIMES[1][0],
                ends_at=PAIR_TIMES[1][1],
            ...
            Lesson(
                ...
                weekday=0,
                pair_number=2,
                starts_at=PAIR_TIMES[2][0],
                ends_at=PAIR_TIMES[2][1],
            ...
            Lesson(
                ...
                weekday=2,
                pair_number=3,
                starts_at=PAIR_TIMES[3][0],
                ends_at=PAIR_TIMES[3][1],
        ...
        # Демо-контактов здесь БОЛЬШЕ НЕТ. Справочник наполняет автозабор с
        # сайта факультета (`python -m src.parsers.econ_staff_runner`), и
        # выдуманные «Иванова Елена Петровна» и «Петров Андрей Сергеевич»
        # стояли в одном списке с настоящими сотрудниками — отличить их
        # студент не мог. Кабинеты и часы приёма, которых нет на сайте,
        # заводятся через админку: такие записи автозабор не трогает.
